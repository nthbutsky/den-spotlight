...
const projects = [
  ...
  },
  {
    name: 'Speekly',
    description:
      'Platform for user generated content videos.',
  ...
  },
  {
    name: 'Virtrex',
    description:
      'B2B platform for shortening sales cycle.',
...
export default function Projects() {
  return (
    <SimpleLayout
      ...
      intro="I’ve worked on many little projects over the years but these are the ones that I’m most proud of. Some of them are in development currently, so the links might be on and off at some point."
    >
      <ul
        role="list"
