    ...
    <SimpleLayout>
      <header className="max-w-2xl">
        <h1 className="text-4xl font-bold tracking-tight text-zinc-800 dark:text-zinc-100 sm:text-5xl">
          <TextGenerateEffect words="Technologies I’m passionate about: tools, software, and gadgets I love." />
        </h1>
        <div className="mt-6 text-base text-zinc-600 dark:text-zinc-400">
          <TextGenerateEffect words="These are some of the tools and technologies I use to build software, upgrade hardware, stay productive, and find inspiration — pushing the boundaries of what’s possible." />
        </div>
      </header>
